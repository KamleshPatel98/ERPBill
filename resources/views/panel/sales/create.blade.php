                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text"
                               name="invoice_no"
                               class="form-control"
                               value="{{ isset($sale) ? $sale->invoice_no : generateNo("Sale", "PUR") }}" 
                               readonly>
                    </div>
        ...
        <div class="card table-card mb-3">
            ...
            <div class="card-body p-0">
                ...
                <div class="table-responsive">
                    ...
                    <table class="table table-bordered align-middle mb-0" id="saleTable">
...
@push('script')
    <script>
        ...
        LIVE UPDATE
        ========================= */
        $(document).on("keyup change", "#saleTable input, #saleTable select", function () {
            updateItems();
        });
